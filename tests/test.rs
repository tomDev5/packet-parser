use pnet::packet::{icmp::IcmpPacket, ipv4::Ipv4OptionNumber};
use std::net::IpAddr;
...
//         ];
//         let parsed = Packet::try_from(packet.as_slice()).expect("Packet parse failed");
//         let Packet::Regular(L2Packet::Ethernet(_, _, L3Packet::Ipv6(ipv6, _))) = &parsed else {panic!("Invalid packet type")};
//         println!("{ipv6:?}")
//     });
//     assert_eq!(allocations, 0, "allocations detected");
// }
